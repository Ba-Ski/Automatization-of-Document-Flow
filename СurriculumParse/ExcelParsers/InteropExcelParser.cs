    ...
    internal class InteropExcelParser : IDocumentParser, IDisposable
    {
        ...
        public Curriculum ParseDocumenr(string path) // ToDo return Cirriculum
        {
            ...
            try
            {
                ...
                var specialityField = usedRange.Find(Constants.Speciality, Type.Missing, // in every documents, cells are the same
                ...
                var basePart = usedRange.Find(Constants.BasePart, Type.Missing,
