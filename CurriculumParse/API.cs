...
namespace СurriculumParse
{
    public class Api:IDisposable
    {
        ...
        {
            // Файл mongod.conf лежит в корне репозитория, для работы его следует расположить в корне диска C:/.
            // Это довольно сомнительный выбор расположения файла.
            // ToDo: обдумать работу с конфигурационным файлом mongod.conf
